...
void InitGame(int[] grid)
{
    ...
    if (zeroIndex - 4 == numbIndex || zeroIndex + 4 == numbIndex || (zeroIndex + 1 == numbIndex && numbIndex != 3 && numbIndex != 7 && numbIndex != 11 ) || (zeroIndex - 1 == numbIndex && numbIndex != 4 && numbIndex != 7 && numbIndex != 11))
    {
